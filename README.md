...
Settings also include an optional "feeding costs no time" checkbox. When enabled, successful robot feeds do not advance static time and the feed drag itself does not cost dynamic game time.
